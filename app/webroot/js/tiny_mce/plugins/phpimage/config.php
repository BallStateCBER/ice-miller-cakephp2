...
// Set the server and url directories depending on whether this is the production or development site
// $server_image_directory: server file directory to store images - IMPORTANT CHANGE PATH TO SUIT YOUR NEEDS!!!
//   e.g. '/home/user/public_html/uploads';
// $url_image_directory: URL directory to stored images (relative or absoulte) - IMPORTANT CHANGE PATH TO SUIT YOUR NEEDS!!!
$server_image_directory	= $_cur_dir.'/img/uploaded';   
$url_image_directory = '/img/uploaded';
